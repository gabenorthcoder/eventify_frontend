...
export default function RegisterStaff(props: { disableCustomTheme?: boolean }) {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
        ...
        await apiService.registerAdmin({ email, password, firstName, lastName, role: 2 }, token);;
  
      setSuccessMessage(`User Registration successful!`);
      setTimeout(() => {
     
        navigate(`/staff/dashboard`, { state: { from: "userRegistration" } });
      }, 2000);
    } catch (err: any) {
